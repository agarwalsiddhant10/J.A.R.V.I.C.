...
def threaded_receive(arg): 
    c=arg[0]
    net, sess, chars, vocab, max_length, beam_width, relevance, temperature, topn = arg[1],arg[2],arg[3],arg[4],arg[5],arg[6],arg[7],arg[8],arg[9]
    ...
    while True: 
        ...
        if not user_command_entered:
            ...
            for i, char_token in enumerate(computer_response_generator):
                ...
                send_msg = send_msg + possibly_escaped_char(out_chars)
            ...
            print (send_msg)
            threaded_send(c, send_msg)

    # connection closed 
    c.close() 


def threaded_send(c, msg):
    # while True:
    #     msg = input("\n")
    if msg is "\n" :
        print("ERROR")
