...
class chatbot:
    ...
    def sample_main(self, args):
        ...
        with tf.Session(config=config) as sess:
            ...
            self.chatbot(net, sess, chars, vocab, args.n, args.beam_width, args.relevance, args.temperature, args.topn)
    ...
    def chatbot(self, net, sess, chars, vocab, max_length, beam_width, relevance, temperature, topn):
        ...
        while True:
            ...
            if not user_command_entered:
                states = self.forward_text(net, sess, states, relevance, vocab, sanitize_text(vocab, "> " + user_input + "\n>"))
                ...
                states = self.forward_text(net, sess, states, relevance, vocab, sanitize_text(vocab, "\n> "))
